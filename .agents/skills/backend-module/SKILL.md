...
4. Conservá nombres, estructura, estilo y patrón de routing de los equivalentes. Para implementar su lógica, aplicá `.agents/skills/backend-code/SKILL.md`; para cada endpoint, aplicá también `.agents/skills/backend-endpoint/SKILL.md`.
